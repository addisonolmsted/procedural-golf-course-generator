//! Quick west/north-edge water renders for the rim-notch fix seeds.
...
fn main() {
    let out = std::path::PathBuf::from(
        std::env::args().nth(1).unwrap_or_else(|| "/tmp/notch_render".into()),
    );
    ...
    for seed in [17u64, 25, 31, 48] {
        ...
        render_s4(&h, &sk, S4View::Water, 1500, true)
